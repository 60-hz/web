...
<label for="reveal-toggle" class="reveal-icon-label" title="Afficher / Masquer">
...
<p>Créateur, chercheur et enseignant, j'explore les nouvelles narrations offertes par les environnements numériques spatialisés et les interfaces sensibles.</p>
...
<p>La transmission est l'autre pilier de mon activité. Depuis 2009, j'enseigne la scénarisation interactive et la culture numérique (<strong>Physical Computing</strong>, <strong>XR</strong>, <strong>IA</strong>) aux Beaux-Arts de Paris, ainsi que dans de nombreuses institutions en France et en Asie.</p>
